...
/**
 * {@code JMomFluentIterable} provides a rich interface for manipulating {@code Iterable} instances in a
 * chained fashion. A {@code JMomFluentIterable} can be created from an {@code Iterable}, or from a set
 * of elements. The following types of methods are provided on {@code JMomFluentIterable}:
 * <ul>
 * <li>chained methods which return a new {@code JMomFluentIterable} based in some way on the contents
 * of the current one (for example {@link #transform})
 * <li>conversion methods which copy the {@code JMomFluentIterable}'s contents into a new collection or
 * array (for example {@link #toList})
 * <li>element extraction methods which facilitate the retrieval of certain elements (for example
 * {@link #last})
 * <li>query methods which answer questions about the {@code JMomFluentIterable}'s contents (for example
 * {@link #anyMatch})
 * </ul>
 * <p>
 ...
 *       .toList();}</pre>
 * <p>
 * <p>Anything which can be done using {@code JMomFluentIterable} could be done in a different fashion
 * (often with {@link Iterables}), however the use of {@code JMomFluentIterable} makes many sets of
...
public abstract class JMomFluentIterable<E> implements Iterable<E> {
    // We store 'iterable' and use it instead of 'this' to allow Iterables to perform instanceof
    // checks on the _original_ iterable when JMomFluentIterable.from is used.
    private final Iterable<E> iterable;

    /**
     * Constructor for use by subclasses.
     */
    protected JMomFluentIterable() {
        this.iterable = this;
    }

    JMomFluentIterable(Iterable<E> iterable) {
     ...
     * is already a {@code JMomFluentIterable}.
     */
    public static <E> JMomFluentIterable<E> from(final E object) {
        final Set<E> setFromOneElement = Sets.newHashSet(object);
        return new JMomFluentIterable<E>(setFromOneElement) {
            @Override
            public Iterator<E> iterator() {
                return setFromOneElement.iterator();
            }
        };
    }
     ...
     * is already a {@code JMomFluentIterable}.
     */
    public static <E> JMomFluentIterable<E> from(final Iterable<E> iterable) {
        return (iterable instanceof JMomFluentIterable) ? (JMomFluentIterable<E>) iterable
                : new JMomFluentIterable<E>(iterable) {
            @Override
            public Iterator<E> iterator() {
     ...
     * {@code JMomFluentIterable} has obviated the need to explicitly convert to a {@code JMomFluentIterable}.
     *
     * @deprecated instances of {@code JMomFluentIterable} don't need to be converted to
     * {@code JMomFluentIterable}
     */
    @Deprecated
    public static <E> JMomFluentIterable<E> from(JMomFluentIterable<E> iterable) {
     ...
     */
    @Beta
    public static <E> JMomFluentIterable<E> of(E[] elements) {
     ...
     * elements.
     */
    public final JMomFluentIterable<E> cycle() {
     ...
     */
    @Beta
    public final JMomFluentIterable<E> append(Iterable<? extends E> other) {
     ...
     */
    @Beta
    public final JMomFluentIterable<E> append(E... elements) {
     ...
     */
    public final JMomFluentIterable<E> filter(Predicate<? super E> predicate) {
     ...
     */
    public final <T> JMomFluentIterable<T> filter(Class<T> type) {
     ...
     */
    public final <T> JMomFluentIterable<T> transform(Function<? super E, T> function) {
     ...
     */
    public <T> JMomFluentIterable<T> transformAndConcat(Function<? super E, ? extends Iterable<? extends T>> function) {
        return (JMomFluentIterable<T>) from(Iterables.concat(transform(function)));
    }
     ...
     */
    public final JMomFluentIterable<E> skip(int numberToSkip) {
     ...
     */
    public final JMomFluentIterable<E> limit(int size) {
     ...
     * JMomFluentIterable} in the order specified by {@code comparator}.  To produce an {@code
     ...
     * JMomFluentIterable} in the order specified by {@code comparator}, with duplicates (determined by
    ...
    /**
     * Returns an immutable map for which the elements of this {@code JMomFluentIterable} are the keys in
     ...
     * specified function to each item in this {@code JMomFluentIterable} of values. Each element of this
     ...
     * {@code JMomFluentIterable} in the given order, and each key is the product of invoking a supplied
    ...
    private static class FromIterableFunction<E>
            implements Function<Iterable<E>, JMomFluentIterable<E>> {
        @Override
        public JMomFluentIterable<E> apply(Iterable<E> fromObject) {
            return JMomFluentIterable.from(fromObject);
        }
    }
